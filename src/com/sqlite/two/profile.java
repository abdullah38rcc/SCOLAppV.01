	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        {			
			public void onClick(View v) 
			{
				...
				go3=new Intent(profile.this,profile.class);
				startActivity(go3);
			}
		});
        ...
        {			
			...
			{
				// TODO Auto-generated method stub
				go3=new Intent(profile.this,Quiz.class);
				startActivity(go3);
			}
		});
        ...
        {			
			public void onClick(View v) 
			{
				go3=new Intent(profile.this,Championship.class);
				startActivity(go3);
				}
        ...
        {			
			...
			{
				// TODO Auto-generated method stub
				go3=new Intent(profile.this,OzuTimes.class);
				startActivity(go3);
			}
		});
